param(
  [string]$XmlPath = "C:\BnF_Arsenal_ms-5219\xml\ms_5219_sd.xml",
  [string]$XslPath = "C:\BnF_Arsenal_ms-5219\xsl\tei2html.xsl",
  [string]$OutPath = "C:\BnF_Arsenal_ms-5219\transcription_ms_5219_sd.html"
)
